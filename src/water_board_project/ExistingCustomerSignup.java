 ...
 * @author User
 */
public class ExistingCustomerSignup extends javax.swing.JFrame {

    /**
     * Creates new form ExistingCustomerLogin
     */
    public ExistingCustomerSignup() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ExistingCustomerSignup.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ExistingCustomerSignup().setVisible(true);
            }
        });
    }
